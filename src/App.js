      ...
      <section id = "Summary" className='bg-opal flex justify-evenly items-center content-center h-screen w-screen'>
        ...
        <div className='flex flex-col bg-gainsboro h-4/5 w-2/3'>
          ...
          <div className='flex justify-center'>
            ...
            <a href='/Nilson_Gao_Resume_28-09-2022-16-07-39.pdf' target="_blank" className="text-lg text-center text-white bg-emerald font-bold tracking-normal rounded-full hover:bg-opal hover:text-black w-1/6 p-2 m-2">Resume</a>
          </div>
        </div>
      </section>
